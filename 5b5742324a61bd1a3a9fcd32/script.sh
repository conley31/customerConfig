#! /usr/bin/env bash
      ...
      fastlane supply --track 'production' --json_key 'google_auth.json' --package_name "jakes-coding-shack" --apk "app.apk" --skip_upload_metadata --skip_upload_images --skip_upload_screenshots
