#! /usr/bin/env bash
      ...
      curl https://raw.githubusercontent.com/kimdaveconley/customerConfig/master/5b5742324a61bd1a3a9fcd32/app.json --output app.json
      curl https://raw.githubusercontent.com/kimdaveconley/customerConfig/master/5b5742324a61bd1a3a9fcd32/config.json --output config.json
      curl https://raw.githubusercontent.com/kimdaveconley/customerConfig/master/5b5742324a61bd1a3a9fcd32/splash.png --output splash.png
      curl https://raw.githubusercontent.com/kimdaveconley/customerConfig/master/5b5742324a61bd1a3a9fcd32/logo.png --output logo.png
